...
public class Test_Inventory : Test_Base
{
    ...
    private void MoveItem()
    {
        ...
        inven.MoveItem(0, 9);   // 1:에메2 2:사파1 2:루비2
        inven.PrintInventory();
        inven.MoveItem(9, 15);  // 실행 안됨
        inven.PrintInventory();

        inven.MoveItem(1, 2);   // 1:사파1 2:에메2 0:루비2
        inven.PrintInventory();
        ...
        inven.AddItem(ItemIDCode.Sapphire, 0);  // 0:사파1, 2:에메2, 9:루비2
        inven.PrintInventory();
        inven.MoveItem(0, 1);   // 1:사파1, 2:에메2, 9:루비2
        inven.PrintInventory();
    }
