...
public class ItemFactory
{
    ...
    // overloading : 이름은 같은데 파라메터가 다른 함수 만드는것
    // overriding : 이름, 파라메터, 리턴값이 같은 함수를 만드는것
    ...
    /// <param name="randomNoise">위치에 랜덤성을 더할지 여부. true면 약간의 앤덤성을 더한다. 기본값은 false</param>
    ...
    /// <summary>
    /// ID를 이용해 특정 위치에 아이템을 한번에 여러개 생성하는 함수
    /// </summary>
    /// <param name="id">생성할 아이템 아이디</param>
    /// <param name="count">생성할 갯수</param>
    /// <param name="position">생성할 기준 위치</param>
