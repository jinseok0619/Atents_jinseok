...
public class Enemy_HP_Bar : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        target.onHealthChange += Refresh;   // 델리게이트 함수 연결
    }
    ...
    /// <summary>
    /// 모든 게임 오브젝트의 Update 함수가 호출 된 이후에 호출되는 Update함수
    /// </summary>
    private void LateUpdate()
    {
        //transform.forward = Camera.main.transform.forward;  // 카메라의 forword와 나의 forward를 일치시킴
