...
namespace _01_Console
{
    ...
    public static class Test
    {
        ...
        //    while (!player.IsDead && !enemy.IsDead)    // human1이 살아있고 human2도 살아있다.
        //    {
        //        Console.WriteLine($"행동울 입력해 주세요 : ");
        //        Console.Write("1.공격, 2방어, 3.스킬");

        //        string TEMP =
        //            Console.ReadLine(); //공격, 방어, 스킬, 입력 
        ...
        //        if (enemy.IsDead)   // human2가 죽으면 공격을 안함
        //        {
        //            break;
        //        }
