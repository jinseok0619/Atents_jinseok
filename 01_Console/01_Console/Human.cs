...
namespace _01_Console
{
    public class Human : Character  // Human 클래스는 Character 클래스를 상속 받았다.
    {
        ...
        public void Skill(Character target)
        {
            ...
            int requirMP = 10;      // 스킬 사용할 때 필요한 마나량

            if( mp - requirMP > 0)  // 스킬을 사용할 수 있을 만큼 마나가 있다면
            {
        ...
        /// 받은 피해 처리 함수
        /// </summary>
        /// <param name="damage">받든 데미지</param>
