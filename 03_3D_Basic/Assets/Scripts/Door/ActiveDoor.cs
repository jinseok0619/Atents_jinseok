...
/// <summary>
/// 수동문 클래스 Door(문의 기본 기능 가짐), IUseableObject(사용할 수 있는 오브젝트라는 특성을 가짐) 상속받음.
/// </summary>
public class ActiveDoor : Door, IUseableObject
{
    /// <summary>
    /// 플레이어가 문을 열수 있는 위체에 있는지 판단하는 변수. true면 플레이러기 문을 열 수 있는 위치에 있다.
    /// </summary>
    bool playerIn = false;

    /// <summary>
    /// 현재 문이 열렸는지를 기록하는 변수. true먄 문이 열려있다.
    /// </summary>
